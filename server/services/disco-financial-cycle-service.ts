...
const JUNE_2025_DISCO_INVOICES: DiscoInvoiceLineItem[] = [
  ...
  },
  {
    ...
    nerc: 501000843.79,
    niso: 286181888.06,
    tcn: (82509614.62), // Negative value - credit
    tif: 467590325.10,
    grossInvoice: 1278980018.16,
    netInvoice: 731814949.97,
  },
  {
    id: '3',
    discoId: 'EKO',
  ...
  },
  {
    ...
    ancillaryServices: 75550132.24,
    nbet: 25769094.22,
    nerc: 472951681.12,
    niso: 271707813.91,
    tcn: 535766333.58,
    tif: 443941249.76,
    grossInvoice: 1825686304.83,
    netInvoice: 1306149922.83,
  },
  {
    id: '5',
    discoId: 'IBADAN',
  ...
  },
  {
    ...
    ancillaryServices: 48976224.14,
    nbet: 16705105.57,
    nerc: 305422705.77,
    niso: 176137650.62,
    tcn: 279133126.65,
    tif: 287789915.27,
    grossInvoice: 1114164728.02,
    netInvoice: 907647221.95,
  },
  {
    id: '8',
    discoId: 'KADUNA',
    discoCode: 'KADUNA',
    discoName: 'Kaduna Electricity Distribution Company',
    ancillaryServices: 57145222.03,
    nbet: 19491436.58,
    nerc: 374314343.02,
    niso: 205516560.93,
    tcn: 70385157.35,
    tif: 335791884.64,
    grossInvoice: 1062644604.55,
    netInvoice: 669709757.88,
  },
  {
    id: '9',
    discoId: 'KANO',
    ...
    ancillaryServices: 57543538.87,
    nbet: 19627296.88,
    nerc: 372092126.74,
    niso: 206949064.02,
    tcn: 301734601.63,
    tif: 338132440.11,
    grossInvoice: 1296079068.25,
    netInvoice: 797581062.37,
  },
  {
    id: '10',
    discoId: 'PH',
    ...
    ancillaryServices: 69262334.60,
    nbet: 23624414.32,
    nerc: 444830819.11,
    niso: 249094435.22,
    tcn: 329281063.57,
    tif: 406993429.03,
    grossInvoice: 1523086495.85,
    netInvoice: 1046831722.22,
  },
  {
    id: '11',
    discoId: 'YOLA',
    ...
    ancillaryServices: 25529934.25,
    nbet: 8707903.77,
    nerc: 159781593.84,
    niso: 91815625.19,
    tcn: 187346533.59,
    tif: 150016824.34,
    grossInvoice: 623198414.97,
    netInvoice: 447651656.38,
  },
];
...
const JUNE_2025_DISCO_INDEBTEDNESS: DiscoIndebtedness[] = [
  ...
  },
  {
    ...
    discoName: 'Benin Electricity Distribution Company',
    period: 'June 2025',
    totalInvoice: 1278980018.16,
    totalInflow: 1278980018.16,
    shortfall: 0.00,
    shortfallPercentage: 0.00,
    current: 1278980018.16,
    overdue30: 0,
    overdue60: 0,
    overdue90: 0,
    overdue120Plus: 0,
  },
  // Other DISCOs with similar structure
  // ... (would include all 11 DISCOs)
];
...
const JUNE_2025_FINANCIAL_CYCLE: DiscoFinancialCycle = {
  ...
  discoSummaries: JUNE_2025_DISCO_INVOICES.map((invoice, index) => ({
    ...
    totalInflow: invoice.grossInvoice * 0.85, // 85% collection rate
    shortfall: invoice.grossInvoice * 0.15, // 15% shortfall

    invoiceLineItem: invoice,
    inflowRecord: JUNE_2025_DISCO_INFLOWS[index],
    indebtedness: JUNE_2025_DISCO_INDEBTEDNESS[index] || {
      id: invoice.id,
      discoId: invoice.discoId,
      discoCode: invoice.discoCode,
      discoName: invoice.discoName,
      period: 'June 2025',
      totalInvoice: invoice.grossInvoice,
      totalInflow: invoice.grossInvoice,
      shortfall: 0,
      shortfallPercentage: 0,
      current: invoice.grossInvoice,
      overdue30: 0,
      overdue60: 0,
      overdue90: 0,
      overdue120Plus: 0,
